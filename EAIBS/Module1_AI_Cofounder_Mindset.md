...
| Block | Topic | Time |
|---|---|---|
| 1.1 | The AI Entrepreneurship Revolution | 20 min |
| 1.2 | The AI-Enhanced Entrepreneur: Ten Competencies Reimagined | 15 min |
| 1.3 | Setting Up Your AI Cofounder Workspace | 15 min |
| 1.4 | The GenAI Toolkit for Founders | 25 min |
| 1.5 | Strategic Positioning with AI | 30 min |
| 📋 | Blueprint Checkpoint 1: Strategic Positioning Statement | 15 min |
...
real customer. You can explore five business model variations in an afternoon. The bottleneck
shifts from *access to resources* to *quality of thinking and judgment*.

| Dimension | Traditional | AI-Enabled |
|---|---|---|
| Market research | Weeks of interviews and desk research | Hours of AI-assisted synthesis + validation |
| Customer insight | Manual surveys and focus groups | AI persona simulation + targeted interviews |
...
## 1.3 Setting Up Your AI Cofounder Workspace

Before you engage with any strategic framework, you need your AI cofounder in the room. In
this block, you will create and configure your **AI Cofounder Workspace** — the persistent
environment that will carry the context of your company concept across all four sessions.
...
The system prompt (also called the *instructions* or *context* depending on your platform)
is the paragraph that tells your AI cofounder who you are, what your company is about, and
how you want it to work with you. Think of it as the briefing you give a new cofounder on
Day 1.

Use the template below as your starting point and adapt it to your concept:
...
will form my company's business plan. Be direct, constructive, and honest when my thinking
has gaps.
...
**Step 3 — Test your Workspace with your first message**

Once your system prompt is set, send this first message to your AI cofounder:
...
question — your Workspace is working. If it sounds generic, refine your system prompt and
try again.
...
With your Workspace configured, let us examine how to get the most out of it. Effective
AI collaboration depends on two foundational skills: **prompt engineering** and
**context engineering**.
...
**What it is:** The specific groups of people or organizations who experience the problem
most acutely and are most likely to pay for a solution.
...
**The UVP formula:**
> For [target customer], [company name] is the [category] that [key benefit] because
> [reason to believe].
...
**What it is:** A structured analysis of your startup's internal **Strengths** and
**Weaknesses**, and the external **Opportunities** and **Threats** in your market.

| | Internal (You control) | External (You don't control) |
|---|---|---|
...
- *Strengths*: AI tools reduce time-to-insight, lower operational costs, enable personalization
  at scale.
- *Weaknesses*: Dependence on third-party AI APIs, data quality challenges, AI literacy gaps
  in team.
- *Opportunities*: Growing market acceptance of AI, underserved niches not yet addressed by
  large incumbents.
...
**Save this document.** At the start of Session 2, you will paste it into your AI Cofounder
Workspace so every subsequent conversation builds on this foundation.
...
- Altman, S. (2019). *How to Start a Startup* (Y Combinator lecture series).
  Available at: [startupclass.samaltman.com](https://startupclass.samaltman.com)
